...
<xsl:template match="rtmp">
    <table cellspacing="1" cellpadding="5">
        ...
        <tr>
            ...
            <th bgcolor="#008B8B">codec</th>
            <th bgcolor="#008B8B">bits/s</th>
            <th bgcolor="#008B8B">size</th>
            <th bgcolor="#008B8B">fps</th>
            <th bgcolor="#008B8B">codec</th>
            <th bgcolor="#008B8B">bits/s</th>
            <th bgcolor="#008B8B">freq</th>
            <th bgcolor="#008B8B">chan</th>
            <td>
...
<xsl:template match="stream">
    <tr valign="top">
        <xsl:attribute name="bgcolor">
            <xsl:choose>
                <xsl:when test="active">#98f26c</xsl:when>
                <xsl:otherwise>#98f26c</xsl:otherwise>
            </xsl:choose>
        </xsl:attribute>
        <td>
            <a href="">

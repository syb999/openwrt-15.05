...
if not lost_state then
	...
	docker_info_table['4ApiVersion']._key = translate("Explanation ")
	docker_info_table['4ApiVersion']._value = translate("Please visit https://download.docker.com/linux/static/stable/ to download docker!! ")
	docker_info_table['5NCPU']._key = translate("Recommended version of arm ")
	docker_info_table['5NCPU']._value = translate("https://download.docker.com/linux/static/stable/armel/docker-18.09.6.tgz ")
	docker_info_table['6MemTotal']._key = translate("Description ")
	docker_info_table['6MemTotal']._value = translate("tar -xzvf docker-18.09.6.tgz && cp docker/* /usr/bin ")
end

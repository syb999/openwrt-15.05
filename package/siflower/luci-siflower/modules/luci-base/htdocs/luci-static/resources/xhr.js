...
XHR = function()
{
	...
	url = location.protocol + '//' + location.host + url;
        ...
        xhr.onreadystatechange = function()
        {
            ...
            var isIE678 = !-[1,];
            if (!isIE678&&xhr.status == 403){
                console.log("this is get 403 error");
    ...
    this.get_with_host = function(host,url,data,callback)
    {
        ...
        xhr.onreadystatechange = function()
        {
            ...
            if (xhr.status == 403){
                console.log("this is get with host 403 error");
                location.href=location.host;
                location.reload();
            }
        }
    ...
    this.post = function(url,data,callback)
    {
        ...
        xhr.onreadystatechange = function()
        {
            if (xhr.readyState == 4)
                callback(xhr);
            if (xhr.status == 403){
                console.log("this is post 403 error");
                location.href=location.host;
                location.reload();
            }
        }
    ...
    this.post_siflower = function(url,data,callback)
    {
        ...
        xhr.onreadystatechange = function()
        {
            ...
            var isIE678 = !-[1,];
            if (!isIE678&&xhr.status == 403){
                console.log("this is post siflower 403 error");
                location.href=location.host;
                location.reload();
            }
        }
        ...
        if (Object.prototype.toString.call(formdata) === '[object FormData]') {
            if(callback != null) {
                xhr.onreadystatechange = function () {
                    ...
                    if (xhr.status == 403){
                        console.log("this is  upload 403 error");
                        location.href=location.host;
                        location.reload();
                    }
                }
